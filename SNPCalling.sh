...
# result Filteredmissing0.57_mergedVCFproject1_2_6_7_8.vcf.gz = 35,987,992

# 3. Thin independent SNPs for Admixture
vcftools --gzvcf Filtered_mergedVCFproject1_2_6_7_8.vcf.gz --out Thinned1SNPevery25kb_Filtered_mergedVCFproject1_2_6_7_8.vcf.gz --thin 25000 --recode 
# result Thinned1SNPevery25kb_Filtered_mergedVCFproject1_2_6_7_8.vcf.gz =

# 4. Subset only speluncae
bcftools view -s Sspeluncae139_lin7,Sspeluncae140_lin5,Sspeluncae116_lin3,Sspeluncae117_lin1,Sspeluncae118_lin1,Sspeluncae119_lin1,Sspeluncae120_lin1,Sspeluncae30_lin5,Sspeluncae32_lin5,Sspeluncae38_lin3,Sspeluncae16_lin4,Sspeluncae19_lin7,Sspeluncae23_lin5,Sspeluncae28_lin5,Sspeluncae46_lin1,Sspeluncae47_lin1,Sspeluncae121_lin1,Sspeluncae122_lin6,Sspeluncae123_lin7 -Oz -o SpeluncaeONLY_Filtered_mergedVCFproject1_2_6_7_8.vcf.gz Filtered_mergedVCFproject1_2_6_7_8.vcf.gz

...
starting_topology=readTopology("(Outgroup,(Lin1,((Lin2,Lin3),(Lin4,((Lin6,Lin7),Lin5)))));")
...
test1 = phyne!(starting_topology,phylip_data,"outgroup",do_hill_climbing=false,number_of_burn_in=30,hmax=5)

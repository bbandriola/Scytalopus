...
# 2. Run HyDe
python run_hyde.py -i NoZW_FilteredPCAandUCE_Max30missingDepthmin10LD015_GeographicNames_SpeluncaeLin1.phy -m map.txt -o Lin1 -n 54 -t 7 -s 1636679 -q --prefix SpeluncaeLin1
...
python individual_hyde.py -i NoZW_FilteredPCAandUCE_Max30missingDepthmin10LD015_GeographicNames_SpeluncaeLin1Snovacap.phy -m map.txt -tr triplets2test.txt -o out -n 55 -t 8 -s 1801056
python individual_hyde.py -i NoZW_FilteredPCAandUCE_Max30missingDepthmin10LD015_GeographicNames_SpeluncaeLin1.phy -m map.txt -tr triplets2test.txt -o Lin1 -n 54 -t 7 -s 1636679 --prefix Individualtest_SpeluncaeLin1 

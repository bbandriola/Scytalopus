...
python individual_hyde.py -i NoZW_FilteredPCAandUCE_Max30missingDepthmin10LD015_GeographicNames_SpeluncaeLin1.phy -m map.txt -tr triplets2test.txt -o out -n 54 -t 7 -s 1636679 -prefix Individualtest_SpeluncaeLin1 

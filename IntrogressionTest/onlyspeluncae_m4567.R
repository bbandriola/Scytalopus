...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-1m4.svg")
plot_graph(winnerb.1m4$edges[[1]], textsize=6)
dev.off()
# 4 migration, 2 run
...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-2m4.svg")
plot_graph(winnerb.2m4$edges[[1]], textsize=6)
dev.off()
# 4 migration, 3 run
...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-3m4.svg")
plot_graph(winnerb.3m4$edges[[1]], textsize=6)
dev.off()
########################################
...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-1m5.svg")
plot_graph(winnerb.1m5$edges[[1]], textsize=6)
dev.off()
# 5 migration, 2 run
...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-2m5.svg")
plot_graph(winnerb.2m5$edges[[1]], textsize=6)
dev.off()
# 5 migration, 3 run
...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-3m5.svg")
plot_graph(winnerb.3m5$edges[[1]], textsize=6)
dev.off()
########################################
...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-1m6.svg")
plot_graph(winnerb.1m6$edges[[1]], textsize=6)
dev.off()
# 6 migration, 2 run
...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-2m6.svg")
plot_graph(winnerb.2m6$edges[[1]], textsize=6)
dev.off()
# 6 migration, 3 run
...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-3m6.svg")
plot_graph(winnerb.3m6$edges[[1]], textsize=6)
dev.off()
########################################
...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-1m7.svg")
plot_graph(winnerb.1m7$edges[[1]], textsize=6)
dev.off()
# 7 migration, 2 run
...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-2m7.svg")
plot_graph(winnerb.2m7$edges[[1]], textsize=6)
dev.off()
# 7 migration, 3 run
...
svg("Thinned1000_maxmissin0.7_FilteredPCAandUCEandOtherspecies_FilteredMax30missingDepthmin5_GeographicNames_allsamples-3m7.svg")
plot_graph(winnerb.3m7$edges[[1]], textsize=6)
dev.off()
########################################
